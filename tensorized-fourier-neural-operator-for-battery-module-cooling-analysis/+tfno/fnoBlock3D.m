...
arguments
    ...
    args.Rank (1, 1) double {mustBeBetween(args.Rank, 0, 1)} = 1
    ...
    layers = [identityLayer(Name="in"), ...
        tfno.tensorizedSpectralConv3dLayer(...
            latentChannelSize, ...
            numModes, ...
            Rank=args.Rank, ...
        ...
        convolution3dLayer(1, ceil(latentChannelSize * args.MLPExpansion), Name="channelMLP1"), ...
